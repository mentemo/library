...
var PDF417Reader = /** @class */ (function () {
     ...
     */
    PDF417Reader.prototype.decodeMultipleOverload1 = function (image) {
     ...
     * @override
     */
    PDF417Reader.prototype.decodeMultipleImpl = function (image, hints) {
        if (hints === void 0) { hints = null; }
        try {
    ...
    PDF417Reader.decode = function (image, hints, multiple) {
        ...
        try {
            for (var _b = __values(detectorResult.getPoints()), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                var result = new Result_1.default(decoderResult.getText(), decoderResult.getRawBytes(), points, BarcodeFormat_1.default.PDF_417);
