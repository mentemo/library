...
export default class Result {
    ...
    private format;
    constructor(text: string, rawBytes: Uint8Array, resultPoints: ResultPoint[], format: BarcodeFormat);
    constructor(text: string, rawBytes: Uint8Array, resultPoints: ResultPoint[], format: BarcodeFormat, timestamp: long);
