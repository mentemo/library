...
var Detector_1 = require("../../../qrcode/detector/Detector");
var ReaderException_1 = require("../../../ReaderException");
var MultiFinderPatternFinder_1 = require("./MultiFinderPatternFinder");
...
var MultiDetector = /** @class */ (function (_super) {
    ...
    MultiDetector.prototype.detectMulti = function (hints) {
        ...
        var finder = new MultiFinderPatternFinder_1.default(image, resultPointCallback);
        ...
        try {
            for (var infos_1 = __values(infos), infos_1_1 = infos_1.next(); !infos_1_1.done; infos_1_1 = infos_1.next()) {
                ...
                try {
                    ...
                    if (e instanceof ReaderException_1.default) {
                        // ignore
                    }
                    else {
                        throw e;
