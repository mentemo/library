        ...
        try {
            for (var results_1 = __values(results), results_1_1 = results_1.next(); !results_1_1.done; results_1_1 = results_1.next()) {
                ...
                if (result.getResultMetadata().has(ResultMetadataType_1.default.STRUCTURED_APPEND_SEQUENCE)) {
                    var parity = result.getResultMetadata().has(ResultMetadataType_1.default.STRUCTURED_APPEND_PARITY) ? result.getResultMetadata().get(ResultMetadataType_1.default.STRUCTURED_APPEND_PARITY) : -1;
